      ...
      .then(async function (answer) {
        ...
        inquirer
          .prompt([
            ...
            // Find IDs to create new record in the employee's table
      ...
      .then(async function (answer) {
        ...
        inquirer
          .prompt([
            ...
            // Find IDs to update record in the employee's table
            const managerID = employeesTable[employeeList.indexOf(ans.manager)].id

            // Insert new employee
            let query = updateManagerQuery;
...
function updateExample(connection) {
  return new Promise(async function (resolve, reject) {
